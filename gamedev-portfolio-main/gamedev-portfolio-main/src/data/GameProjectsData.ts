...
export default [
    new ProjectData("project-1", "Gun for All", "img/projects/project-1-icon.png", 
    `
    <div class="paragraph">
     <strong>Gun for All</strong> is a thing of beauty that I am so proud of. It's available on Android because why not.
